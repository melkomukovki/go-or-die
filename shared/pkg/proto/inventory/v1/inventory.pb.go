...
// Запрос на получения списка деталей
type ListPartsRequest struct {
	...
	// Список конкретных UUID (опционально)
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBMZKgithub.com/melkomukovki/go-or-die/shared/pkg/proto/inventory/v1;inventoryv1b\x06proto3"
