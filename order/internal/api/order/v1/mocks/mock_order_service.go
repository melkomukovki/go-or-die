// Code generated for melkomukovki service
// © Melkomukov K.I. 2026.
...
func (_mock *OrderService) Create(ctx context.Context, req model.CreateOrderInput) (model.Order, error) {
	...
	var r0 model.Order
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, model.CreateOrderInput) (model.Order, error)); ok {
		return returnFunc(ctx, req)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, model.CreateOrderInput) model.Order); ok {
...
func (_c *OrderService_Create_Call) Run(run func(ctx context.Context, req model.CreateOrderInput)) *OrderService_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *OrderService_Create_Call) RunAndReturn(run func(ctx context.Context, req model.CreateOrderInput) (model.Order, error)) *OrderService_Create_Call {
	_c.Call.Return(run)
	return _c
}
